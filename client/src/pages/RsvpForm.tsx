...
export default function RsvpForm() {
  ...
  const { data: eventData, isLoading, isError } = useQuery({
    queryKey: ['event-public', slug] as const,
  ...
  const submitMutation = useMutation({
    mutationFn: (data: RsvpFormData) => guestsApi.rsvp(slug!, data as Rsvp),
  ...
  const onSubmit: SubmitHandler<RsvpFormData> = (d) => submitMutation.mutate(d);
