...
import { eventsApi, type EventWithCounts } from '../api/events';
...
export default function Dashboard() {
  ...
  const archiveMutation = useMutation({
    mutationFn: (id: string) => eventsApi.archive(id),
...
function EventCard({ event, onEdit, onGuests, onCopy, onPublish, onArchive, menuOpen, onMenuToggle }: EventCardProps) {
